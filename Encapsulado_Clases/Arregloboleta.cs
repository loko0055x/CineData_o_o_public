...
namespace Encapsulado_Clases
{
    public class Arregloboleta
    {
        ...
        public Arregloboleta(string nombre, string apellido, string correo, string nombrepeli, List<TipoEntrada> arregloentrada, double subtotalentradas, List<Dulceria> arreglodul, double subtotaldulceria, string tipopago, double total, List<Nombresala> arreglobutacas, DateTime fecha)
        {
            this.nombre = nombre;
