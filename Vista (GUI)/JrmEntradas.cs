...
{
    public partial class JrmEntradas : Form
    {
        public JrmEntradas()
        {
            InitializeComponent();
            ...
            lvlcantidad.Text = "" + JrmButacas.contador;
        ...
        {
            if (Jrm_IniciarSecion.estadoiniciarsecion == true || JrmRegistrar.estadoregistrarse == true)
            {
                pictureBox1.ImageLocation = "C:/Users/Windows 10/source/repos/Proyecto Final Cine Data O_O/Imagenes/cara-feliz.png";
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
                lvlletra.Text = "Felicidades Eres Beneficiario";
            }
            else {
                pictureBox1.ImageLocation = "C:/Users/Windows 10/source/repos/Proyecto Final Cine Data O_O/Imagenes/cara-triste.png";
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
        ...
        private void JrmEntradas_Load(object sender, EventArgs e)
        {
        }
        ...
        int ejex = 400;//este es para mas ala derecha 
        int ejey = 133;//este es para mas abajo
    //    int ejey = 110;//este es para mas abajo
        ...
        void verentradasescogida() {
            for (int i = 0; i < 3; i++)
            {
                if (arr[i]>=1)
                {
                    ...
                    EntradaConectar_BD.mostrardulceriaescogida(i + 1);
        ...
        private void btnniniosmenos_Click_2(object sender, EventArgs e)
        {
            num3--;
            matriz[2, 0].Text = "" + num3;
            inabilitarbotonsiescero();
        ...
        private void btnsiguiente_Click(object sender, EventArgs e)
        {
            ...
            JrmDulceria hh = new JrmDulceria();
            hh.Visible = true;
            this.Hide();
